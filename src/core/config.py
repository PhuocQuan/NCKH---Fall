...
class DetectorConfig:
    ...
    torso_fall_angle_deg: float = 58.0
    torso_upright_angle_deg: float = 32.0
    head_hip_height_ratio: float = 0.25
    hip_drop_velocity: float = 0.025
    angle_change_velocity_deg: float = 14.0
    min_fall_frames: int = 6
    warning_frames: int = 2
    alert_after_seconds: float = 2.5
