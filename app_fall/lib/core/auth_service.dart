...
class AuthService {
  ...
  String? _token;
  String? _email;
  String _serverUrl = kIsWeb ? 'http://127.0.0.1:8000' : 'https://nckh-fall.onrender.com';
  ...
  Future<void> init() async {
    ...
    _serverUrl = prefs.getString(_keyServerUrl) ?? (kIsWeb ? 'http://127.0.0.1:8000' : 'https://nckh-fall.onrender.com');
    
    // Auto-fix for Web users who accidentally saved the Android emulator IP
    if (kIsWeb && _serverUrl == 'https://nckh-fall.onrender.com') {
